package com.lb.demo.role.config;
...
@MapperScan(basePackages = "com.lb.demo.role.mapper", sqlSessionFactoryRef = "roleSqlSessionFactory")
@EnableConfigurationProperties({RoleDBProperty.class })
public class RoleDBConfig {
	@Autowired
	private RoleDBProperty property;

    @Bean(name = "roleSqlDataSource")
    public DataSource dataSource() {
    	System.out.println("加载role数据库!!!");
